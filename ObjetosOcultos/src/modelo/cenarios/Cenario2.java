...
public class Cenario2 implements TrocaDeCenarios {
	
	private Jogador jogador;
	
	public Cenario2(Jogador jogador, EstrategiaGameSet estrategia) {
	...
	@Override
	public void cenario2() throws ExcecaoLocalAtual {
